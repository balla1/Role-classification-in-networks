...
G95 = nx.read_weighted_edgelist(f'{file_base}{year}\\1995_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
...
G95_c = nx.read_weighted_edgelist(f'{file_base}{year}\\1995_closeness_SECTION_II.txt', create_using=nx.DiGraph)
...
G95_e = nx.read_weighted_edgelist(f'{file_base}{year}\\1995_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
feat = features.drop(columns=['out_strength','betweenness','authorities'], axis=1)
...
V = pd.DataFrame(fcm.centers, columns = ['eigenvector', 'clustering coefficient',' total_strength',' in_strength',' out_closeness','in_closeness','hubs','pagerank'])
...
nx.write_graphml(G95, f'{salvataggio}1995_section_II.graphml')

# Colori consistenti per i ruoli
role_colors = {'Role_0': 'blue', 'Role_1': 'red', 'Role_2': 'green'}

# Posizione dei nodi
pos = nx.spring_layout(G95,k=0.03)  # o una posizione predefinita se disponibile
...
#plt.show()
plt.savefig(f'{salvataggio}g95_section_II.png',bbox_inches='tight')
plt.close()
...
# 
G96 = nx.read_weighted_edgelist(f'{file_base}{year}\\1996_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G96_c = nx.read_weighted_edgelist(f'{file_base}{year}\\1996_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G96_e = nx.read_weighted_edgelist(f'{file_base}{year}\\1996_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=1997
# 
G97 = nx.read_weighted_edgelist(f'{file_base}{year}\\1997_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G97_c = nx.read_weighted_edgelist(f'{file_base}{year}\\1997_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G97_e = nx.read_weighted_edgelist(f'{file_base}{year}\\1997_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=1998
# 
G98 = nx.read_weighted_edgelist(f'{file_base}{year}\\1998_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G98_c = nx.read_weighted_edgelist(f'{file_base}{year}\\1998_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G98_e = nx.read_weighted_edgelist(f'{file_base}{year}\\1998_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=1999
# 
G99 = nx.read_weighted_edgelist(f'{file_base}{year}\\1999_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G99_c = nx.read_weighted_edgelist(f'{file_base}{year}\\1999_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G99_e = nx.read_weighted_edgelist(f'{file_base}{year}\\1999_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2000
# 
G00 = nx.read_weighted_edgelist(f'{file_base}{year}\\2000_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G00_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2000_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G00_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2000_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2001
# 
G01 = nx.read_weighted_edgelist(f'{file_base}{year}\\2001_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G01_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2001_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G01_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2001_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2002
# 
G02 = nx.read_weighted_edgelist(f'{file_base}{year}\\2002_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G02_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2002_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G02_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2002_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2003
# 
G03 = nx.read_weighted_edgelist(f'{file_base}{year}\\2003_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G03_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2003_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G03_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2003_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year= 2004
# 
G04 = nx.read_weighted_edgelist(f'{file_base}{year}\\2004_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G04_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2004_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G04_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2004_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2005
# 
G05 = nx.read_weighted_edgelist(f'{file_base}{year}\\2005_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G05_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2005_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G05_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2005_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2006
# 
G06 = nx.read_weighted_edgelist(f'{file_base}{year}\\2006_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G06_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2006_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G06_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2006_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2007
# 
G07 = nx.read_weighted_edgelist(f'{file_base}{year}\\2007_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G07_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2007_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G07_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2007_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2008
# 
G08 = nx.read_weighted_edgelist(f'{file_base}{year}\\2008_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G08_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2008_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G08_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2008_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
G09 = nx.read_weighted_edgelist(f'{file_base}{year}\\2009_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G09_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2009_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G09_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2009_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2010   
# 
G10 = nx.read_weighted_edgelist(f'{file_base}{year}\\2010_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G10_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2010_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G10_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2010_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2011
# 
G11 = nx.read_weighted_edgelist(f'{file_base}{year}\\2011_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G11_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2011_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G11_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2011_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2012
# 
G12 = nx.read_weighted_edgelist(f'{file_base}{year}\\2012_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G12_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2012_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G12_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2012_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2013
# 
G13 = nx.read_weighted_edgelist(f'{file_base}{year}\\2013_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G13_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2013_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G13_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2013_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2014
# 
G14 = nx.read_weighted_edgelist(f'{file_base}{year}\\2014_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G14_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2014_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G14_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2014_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2015
# 
G15 = nx.read_weighted_edgelist(f'{file_base}{year}\\2015_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G15_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2015_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G15_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2015_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2016
# 
G16 = nx.read_weighted_edgelist(f'{file_base}{year}\\2016_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G16_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2016_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G16_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2016_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2017
# 
G17 = nx.read_weighted_edgelist(f'{file_base}{year}\\2017_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G17_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2017_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G17_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2017_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
year=2018
# 
G18 = nx.read_weighted_edgelist(f'{file_base}{year}\\2018_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)
G18_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2018_closeness_SECTION_II.txt', create_using=nx.DiGraph)
G18_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2018_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
# 
#dati normalizzati (\sum_{i,j=1}^N a_{ij}=1, dove A=[a_{ij}] è la matrice di adiacenza pesata che descrive la rete)
G19 = nx.read_weighted_edgelist(f'{file_base}{year}\\2019_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)


#dati invertiti (a'_{ij}=a_{ij}^-1) per calcolare la closeness, in modo che sugli archi i pesi siano invertiti,
#visto che due paesi sono tanto più "vicini" (economicamente parlando) quanto più commerciano fra loro
G19_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2019_closeness_SECTION_II.txt', create_using=nx.DiGraph)


#dati iniziali senza modifiche, visto che con dati normalizzati l'algoritmo che estrae l'eigenvector centrality ha problemi di convergenza.
#con dati iniziali non ci sono comunque problemi per quanto riguarda l'ordine di grandezza della eigenvector estratta dai nodi
G19_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2019_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
# 
#dati normalizzati (\sum_{i,j=1}^N a_{ij}=1, dove A=[a_{ij}] è la matrice di adiacenza pesata che descrive la rete)
G20 = nx.read_weighted_edgelist(f'{file_base}{year}\\2020_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)


#dati invertiti (a'_{ij}=a_{ij}^-1) per calcolare la closeness, in modo che sugli archi i pesi siano invertiti,
#visto che due paesi sono tanto più "vicini" (economicamente parlando) quanto più commerciano fra loro
G20_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2020_closeness_SECTION_II.txt', create_using=nx.DiGraph)


#dati iniziali senza modifiche, visto che con dati normalizzati l'algoritmo che estrae l'eigenvector centrality ha problemi di convergenza.
#con dati iniziali non ci sono comunque problemi per quanto riguarda l'ordine di grandezza della eigenvector estratta dai nodi
G20_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2020_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
nx.write_graphml(G20, f'{salvataggio}2020_section_II.graphml')

# Colori consistenti per i ruoli
role_colors = {'Role_0': 'blue', 'Role_1': 'red', 'Role_2': 'green'}

# Posizione dei nodi
pos = nx.spring_layout(G20,k=0.03)  # o una posizione predefinita se disponibile
...
# Disegno degli archi
edges = nx.draw_networkx_edges(G20, pos, ax=ax, alpha=0.03, edge_color='gray',width=0.5)  # riduci l'alpha per trasparenza, cambia il colore per meno visibilità
# Aggiunta della legenda
ax.legend(wedges, ['Role_0', 'Role_1', 'Role_2'], title="Roles", loc="best")
...
#plt.show()
plt.savefig(f'{salvataggio}g20_section_II.png',bbox_inches='tight')
plt.close()
...
# 
#dati normalizzati (\sum_{i,j=1}^N a_{ij}=1, dove A=[a_{ij}] è la matrice di adiacenza pesata che descrive la rete)
G21 = nx.read_weighted_edgelist(f'{file_base}{year}\\2021_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)


#dati invertiti (a'_{ij}=a_{ij}^-1) per calcolare la closeness, in modo che sugli archi i pesi siano invertiti,
#visto che due paesi sono tanto più "vicini" (economicamente parlando) quanto più commerciano fra loro
G21_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2021_closeness_SECTION_II.txt', create_using=nx.DiGraph)


#dati iniziali senza modifiche, visto che con dati normalizzati l'algoritmo che estrae l'eigenvector centrality ha problemi di convergenza.
#con dati iniziali non ci sono comunque problemi per quanto riguarda l'ordine di grandezza della eigenvector estratta dai nodi
G21_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2021_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
# 
#dati normalizzati (\sum_{i,j=1}^N a_{ij}=1, dove A=[a_{ij}] è la matrice di adiacenza pesata che descrive la rete)
G22 = nx.read_weighted_edgelist(f'{file_base}{year}\\2022_normalizzato_SECTION_II.txt', create_using=nx.DiGraph)


#dati invertiti (a'_{ij}=a_{ij}^-1) per calcolare la closeness, in modo che sugli archi i pesi siano invertiti,
#visto che due paesi sono tanto più "vicini" (economicamente parlando) quanto più commerciano fra loro
G22_c = nx.read_weighted_edgelist(f'{file_base}{year}\\2022_closeness_SECTION_II.txt', create_using=nx.DiGraph)


#dati iniziali senza modifiche, visto che con dati normalizzati l'algoritmo che estrae l'eigenvector centrality ha problemi di convergenza.
#con dati iniziali non ci sono comunque problemi per quanto riguarda l'ordine di grandezza della eigenvector estratta dai nodi
G22_e = nx.read_weighted_edgelist(f'{file_base}{year}\\2022_paesi_edgelist_SECTION_II.txt', create_using=nx.DiGraph)
...
nx.write_graphml(G22, f'{salvataggio}2022_section_II.graphml')

# Colori consistenti per i ruoli
role_colors = {'Role_0': 'blue', 'Role_1': 'red', 'Role_2': 'green'}

# Posizione dei nodi
pos = nx.spring_layout(G22,k=0.03)  # o una posizione predefinita se disponibile
...
# Disegno degli archi
edges = nx.draw_networkx_edges(G22, pos, ax=ax, alpha=0.05, edge_color='gray',width=0.5)  # riduci l'alpha per trasparenza, cambia il colore per meno visibilità
# Aggiunta della legenda
ax.legend(wedges, ['Role_0', 'Role_1', 'Role_2'], title="Roles", loc="best")
...
#plt.show()
plt.savefig(f'{salvataggio}g22_section_II.png',bbox_inches='tight')
plt.close()
# 
...
for i in range(len(ita_coord)):
    ...
    #role_3_qat.append(qat_coord[i][3])
...
plt.title('Italy')
#plt.show()
plt.savefig('ITA_section_II.png',bbox_inches='tight')
plt.close()
...
plt.title('China')
#plt.show()
plt.savefig('CHI_section_II.png',bbox_inches='tight')
plt.close()
...
plt.title('USA')
#plt.show()
plt.savefig('USA_section_II.png',bbox_inches='tight')
plt.close()

# 
plt.plot(x, role_0_qat, label="role_0")
plt.plot(x, role_1_qat, label="role_1")
plt.plot(x, role_2_qat, label="role_2")
#plt.plot(x, role_3_qat, label="role_3")
plt.legend(bbox_to_anchor =(0.0,-0.17, 1, -0.027), mode= 'expand', loc='lower center', borderaxespad=0., ncols=3)
plt.title('Qatar')
#plt.show()
plt.savefig('QAT_section_II.png',bbox_inches='tight')
plt.close()
...
plt.title('Japan')
#plt.show()
plt.savefig('JPN_section_II.png',bbox_inches='tight')
plt.close()
...
plt.title('India')
#plt.show()
plt.savefig('IND_section_II.png',bbox_inches='tight')
plt.close()
...
plt.title('Ucraina')
#plt.show()
plt.savefig('UKR_section_II.png',bbox_inches='tight')
plt.close()

# Rand score
# Filtra le etichette per mantenere solo i paesi comuni tra gli anni
common_countries = set(features.index)
for year_labels in [labels_1995, labels_1996, labels_1997, labels_1998, labels_1999, labels_2000, labels_2001, labels_2002, labels_2003, labels_2004, labels_2005, labels_2006, labels_2007, labels_2008, labels_2009, labels_2010, labels_2011, labels_2012, labels_2013, labels_2014, labels_2015, labels_2016, labels_2017, labels_2018, labels_2019, labels_2020, labels_2021, labels_2022]:
    common_countries.intersection_update(set(features.index[features.index.isin(year_labels)]))

# Crea le etichette filtrate solo per i paesi comuni
filtered_labels_1995 = [labels_1995[features.index.get_loc(country)] for country in common_countries]
filtered_labels_1996 = [labels_1996[features.index.get_loc(country)] for country in common_countries]
filtered_labels_1997 = [labels_1997[features.index.get_loc(country)] for country in common_countries]
filtered_labels_1998 = [labels_1998[features.index.get_loc(country)] for country in common_countries]
filtered_labels_1999 = [labels_1999[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2000 = [labels_2000[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2001 = [labels_2001[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2002 = [labels_2002[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2003 = [labels_2003[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2004 = [labels_2004[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2005 = [labels_2005[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2006 = [labels_2006[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2007 = [labels_2007[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2008 = [labels_2008[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2009 = [labels_2009[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2010 = [labels_2010[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2011 = [labels_2011[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2012 = [labels_2012[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2013 = [labels_2013[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2014 = [labels_2014[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2015 = [labels_2015[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2016 = [labels_2016[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2017 = [labels_2017[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2018 = [labels_2018[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2019 = [labels_2019[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2020 = [labels_2020[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2021 = [labels_2021[features.index.get_loc(country)] for country in common_countries]
filtered_labels_2022 = [labels_2022[features.index.get_loc(country)] for country in common_countries]

# Calcola i Rand Scores sui paesi comuni
from sklearn.metrics import rand_score

rand_scores = [
    rand_score(filtered_labels_1995, filtered_labels_1996),
    rand_score(filtered_labels_1996, filtered_labels_1997),
    rand_score(filtered_labels_1997, filtered_labels_1998),
    rand_score(filtered_labels_1998, filtered_labels_1999),
    rand_score(filtered_labels_1999, filtered_labels_2000),
    rand_score(filtered_labels_2000, filtered_labels_2001),
    rand_score(filtered_labels_2001, filtered_labels_2002),
    rand_score(filtered_labels_2002, filtered_labels_2003),
    rand_score(filtered_labels_2003, filtered_labels_2004),
    rand_score(filtered_labels_2004, filtered_labels_2005),
    rand_score(filtered_labels_2005, filtered_labels_2006),
    rand_score(filtered_labels_2006, filtered_labels_2007),
    rand_score(filtered_labels_2007, filtered_labels_2008),
    rand_score(filtered_labels_2008, filtered_labels_2009),
    rand_score(filtered_labels_2009, filtered_labels_2010),
    rand_score(filtered_labels_2010, filtered_labels_2011),
    rand_score(filtered_labels_2011, filtered_labels_2012),
    rand_score(filtered_labels_2012, filtered_labels_2013),
    rand_score(filtered_labels_2013, filtered_labels_2014),
    rand_score(filtered_labels_2014, filtered_labels_2015),
    rand_score(filtered_labels_2015, filtered_labels_2016),
    rand_score(filtered_labels_2016, filtered_labels_2017),
    rand_score(filtered_labels_2017, filtered_labels_2018),
    rand_score(filtered_labels_2018, filtered_labels_2019),
    rand_score(filtered_labels_2019, filtered_labels_2020),
    rand_score(filtered_labels_2020, filtered_labels_2021),
    rand_score(filtered_labels_2021, filtered_labels_2022)
]
...
plt.savefig(f'{salvataggio}rand_score_section_II.png', bbox_inches='tight')
plt.close()
