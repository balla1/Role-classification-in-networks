...
file_base = "D:\\Mattia Ballardini\\TESI\\role_network_analysis\\oecd_aziende\\oecd_per_anni_aziende\\"
# 
...
G95_e = nx.read_weighted_edgelist(f'{file_base}1995_aziende_edgelist.txt', create_using=nx.DiGraph)
...
feat = features.drop(columns=['betweenness','out_closeness', 'selfloop'], axis=1)
...
V = pd.DataFrame(fcm.centers, columns = ['in_strength','out_strength','total_strength', 'eigenvector', 'in_closeness', 'clustering_coefficient',  'pagerank', 'hubs', 'authorities'])
print("Indici V originale:", V.index)
print("Matrice V originale:")
print(V)
#aggiunta di una colonna che rappresenta la somma delle feature per ogni nodo
V['sum'] = V.sum(axis=1)
...
# A01, D, C24, C10T12, P, K, J61
# A01: Agriculture, hunting, forestry and fishing
# D: Manufacturing
# C24: Manufacture of chemicals and chemical products
# C10T12: Manufacture of food products, beverages and tobacco
# P: Education
# K: Financial intermediation
# J61: Telecommunications
coords = roles_percentages_sorted.loc['A01'].tolist()
A01_coord.append(coords)
coord = roles_percentages_sorted.loc['D'].tolist()
D_coord.append(coord)
coor = roles_percentages_sorted.loc['C24'].tolist()
C24_coord.append(coor)
c_u = roles_percentages_sorted.loc['C10T12'].tolist()
C10T12_coord.append(c_u)

# Supponiamo di voler scambiare i valori di Role_0 tra 'Node1' e 'Node2'
#temp = roles_percentages_sorted.loc['P', 'Role_2']
#roles_percentages_sorted.loc['P', 'Role_2'] = roles_percentages_sorted.loc['P', 'Role_1']
#roles_percentages_sorted.loc['P', 'Role_1'] = temp
c_j = roles_percentages_sorted.loc['P'].tolist()
P_coord.append(c_j)
c_i = roles_percentages_sorted.loc['K'].tolist()
K_coord.append(c_i)
c_k = roles_percentages_sorted.loc['J61'].tolist()
J61_coord.append(c_k)
# 
...
# Posizione dei nodi
pos = nx.spring_layout(G95,k=0.08)  # o una posizione predefinA01 se disponibile
...
G96_e = nx.read_weighted_edgelist(f'{file_base}1996_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G97_e = nx.read_weighted_edgelist(f'{file_base}1997_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G98_e = nx.read_weighted_edgelist(f'{file_base}1998_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G99_e = nx.read_weighted_edgelist(f'{file_base}1999_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G00_e = nx.read_weighted_edgelist(f'{file_base}2000_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G01_e = nx.read_weighted_edgelist(f'{file_base}2001_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G02_e = nx.read_weighted_edgelist(f'{file_base}2002_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G03_e = nx.read_weighted_edgelist(f'{file_base}2003_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G04_e = nx.read_weighted_edgelist(f'{file_base}2004_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G05_e = nx.read_weighted_edgelist(f'{file_base}2005_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G06_e = nx.read_weighted_edgelist(f'{file_base}2006_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G07_e = nx.read_weighted_edgelist(f'{file_base}2007_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G08_e = nx.read_weighted_edgelist(f'{file_base}2008_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G09_e = nx.read_weighted_edgelist(f'{file_base}2009_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G10_e = nx.read_weighted_edgelist(f'{file_base}2010_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G11_e = nx.read_weighted_edgelist(f'{file_base}2011_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G12_e = nx.read_weighted_edgelist(f'{file_base}2012_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G13_e = nx.read_weighted_edgelist(f'{file_base}2013_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G14_e = nx.read_weighted_edgelist(f'{file_base}2014_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G15_e = nx.read_weighted_edgelist(f'{file_base}2015_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G16_e = nx.read_weighted_edgelist(f'{file_base}2016_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G17_e = nx.read_weighted_edgelist(f'{file_base}2017_aziende_edgelist.txt', create_using=nx.DiGraph)
...
G18_e = nx.read_weighted_edgelist(f'{file_base}2018_aziende_edgelist.txt', create_using=nx.DiGraph)
...
#dati iniziali senza modifiche, visto che con dati normalizzati l'algoritmo che estrae l'eigenvector centrality ha problemi di convergenza.
#con dati iniziali non ci sono comunque problemi per quanto riguarda l'ordine di grandezza della eigenvector estratta dai nodi
G19_e = nx.read_weighted_edgelist(f'{file_base}2019_aziende_edgelist.txt', create_using=nx.DiGraph)
...
#dati iniziali senza modifiche, visto che con dati normalizzati l'algoritmo che estrae l'eigenvector centrality ha problemi di convergenza.
#con dati iniziali non ci sono comunque problemi per quanto riguarda l'ordine di grandezza della eigenvector estratta dai nodi
G20_e = nx.read_weighted_edgelist(f'{file_base}2020_aziende_edgelist.txt', create_using=nx.DiGraph)
...
# Posizione dei nodi
pos = nx.spring_layout(G20,k=0.06)  # o una posizione predefinita se disponibile
...
#print("A01:",A01_coord)
#print("D:",D_coord)
#print("C10T12:",C10T12_coord)
#print("C24:",C24_coord)
#print("P:",P_coord)
#print("ind:",K_coord)
#print("J61:",J61_coord)
for i in range(len(A01_coord)):
    role_0_A01.append(A01_coord[i][0])
    role_1_A01.append(A01_coord[i][1])
    role_2_A01.append(A01_coord[i][2])
    #role_3_A01.append(A01_coord[i][3])
    role_0_D.append(D_coord[i][0])
    role_1_D.append(D_coord[i][1])
    role_2_D.append(D_coord[i][2])
    #role_3_D.append(D_coord[i][3])
    role_0_C24.append(C24_coord[i][0])
    role_1_C24.append(C24_coord[i][1])
    role_2_C24.append(C24_coord[i][2])
    #role_3_C24.append(C24_coord[i][3])
    role_0_C10T12.append(C10T12_coord[i][0])
    role_1_C10T12.append(C10T12_coord[i][1])
    role_2_C10T12.append(C10T12_coord[i][2])
    #role_3_C10T12.append(C10T12_coord[i][3])
    role_0_P.append(P_coord[i][0])
    role_1_P.append(P_coord[i][1])
    role_2_P.append(P_coord[i][2])
    #role_3_P.append(P_coord[i][3])
    role_0_K.append(K_coord[i][0])
    role_1_K.append(K_coord[i][1])
    role_2_K.append(K_coord[i][2])
    #role_3_K.append(K_coord[i][3])
    role_0_J61.append(J61_coord[i][0])
    role_1_J61.append(J61_coord[i][1])
    role_2_J61.append(J61_coord[i][2])
    #role_3_J61.append(J61_coord[i][3])

print("role A01 0:",role_0_A01)
print("role A01 1:",role_1_A01)
print("role A01 2:",role_2_A01)
# 
...
# 
plt.plot(x, role_0_A01, label="role_0")
plt.plot(x, role_1_A01, label="role_1")
plt.plot(x, role_2_A01, label="role_2")
#plt.plot(x, role_3_A01, label="role_3")
plt.legend(bbox_to_anchor =(0.0,-0.17, 1, -0.027), mode= 'expand', loc='lower center', borderaxespad=0., ncols=3)
plt.title('A01')
#plt.show()
plt.savefig('A01.png',bbox_inches='tight')
plt.close()

# 
plt.plot(x, role_0_D, label="role_0")
plt.plot(x, role_1_D, label="role_1")
plt.plot(x, role_2_D, label="role_2")
#plt.plot(x, role_3_D, label="role_3")
...
# 
plt.plot(x, role_0_C10T12, label="role_0")
plt.plot(x, role_1_C10T12, label="role_1")
plt.plot(x, role_2_C10T12, label="role_2")
#plt.plot(x, role_3_C10T12, label="role_3")
plt.legend(bbox_to_anchor =(0.0,-0.17, 1, -0.027), mode= 'expand', loc='lower center', borderaxespad=0., ncols=3)
plt.title('C10T12')
#plt.show()
plt.savefig('C10T12.png',bbox_inches='tight')
plt.close()

# 
plt.plot(x, role_0_C24, label="role_0")
plt.plot(x, role_1_C24, label="role_1")
plt.plot(x, role_2_C24, label="role_2")
#plt.plot(x, role_3_C24, label="role_3")
plt.legend(bbox_to_anchor =(0.0,-0.17, 1, -0.027), mode= 'expand', loc='lower center', borderaxespad=0., ncols=3)
plt.title('C24')
#plt.show()
plt.savefig('C24.png',bbox_inches='tight')
plt.close()

# 
plt.plot(x, role_0_P, label="role_0")
plt.plot(x, role_1_P, label="role_1")
plt.plot(x, role_2_P, label="role_2")
#plt.plot(x, role_3_P, label="role_3")
plt.legend(bbox_to_anchor =(0.0,-0.17, 1, -0.027), mode= 'expand', loc='lower center', borderaxespad=0., ncols=3)
plt.title('P')
#plt.show()
...
# 
plt.plot(x, role_0_K, label="role_0")
plt.plot(x, role_1_K, label="role_1")
plt.plot(x, role_2_K, label="role_2")
#plt.plot(x, role_3_K, label="role_3")
plt.legend(bbox_to_anchor =(0.0,-0.17, 1, -0.027), mode= 'expand', loc='lower center', borderaxespad=0., ncols=3)
plt.title('K')
#plt.show()
...
plt.plot(x, role_0_J61, label="role_0")
plt.plot(x, role_1_J61, label="role_1")
plt.plot(x, role_2_J61, label="role_2")
#plt.plot(x, role_3_J61, label="role_3")
plt.legend(bbox_to_anchor =(0.0,-0.17, 1, -0.027), mode= 'expand', loc='lower center', borderaxespad=0., ncols=3)
plt.title('J61')
#plt.show()
plt.savefig('J61.png',bbox_inches='tight')
plt.close()
